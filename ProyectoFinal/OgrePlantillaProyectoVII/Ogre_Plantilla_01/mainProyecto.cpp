...
public:
	...
	void crearMonedas() {
		for (int i = 0;i < 5;i++) {
			monedas1[i] = Moneda(mSceneMgr,0,4,250+(20*i));
		}

		for (int i = 0;i < 5;i++) {
			monedas2[i] = Moneda(mSceneMgr,-150,4,500+(60*i));
		}

		for (int i = 0; i < 10;i++) {
			if (i < 5)
				monedas3[i] = Moneda(mSceneMgr,-100+(60*i),4,625);
			else 
				monedas3[i] = Moneda(mSceneMgr,150,4,350+(i*60));
		}

		for (int i = 0;i < 11;i++) {
			monedas4[i] = Moneda(mSceneMgr,150-(30*i),4,930+(i*30));
		}
		...
		for (int i = 0;i < 20;i++) {
			if (i < 5) 
				...
				monedas7[i] = Moneda(mSceneMgr,0,-10,9000 + ((i-5)*30));
		}
	}
